    ...
    <section className="relative py-40 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Статистика и масштаб проблемы</span>
        ...
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Каждые 39 секунд в мире происходит кибератака.</span> В 2024 году ущерб от интернет-мошенничества в России превысил 15 миллиардов рублей. Будьте осведомлены — будьте защищены.
        </p>
          ...
          >
            ...
            <div className="relative h-[400px]">
              ...
              >
                ...
                <span className="text-zinc-300 text-sm font-medium">Фишинговые атаки — рост 300% за год</span>
                <div
              ...
              >
                ...
                <span className="text-zinc-500 text-sm">Скам в соцсетях</span>
              </div>
              ...
              >
                <span className="text-zinc-400 text-sm">Телефонное мошенничество</span>
              ...
              >
                <span className="text-zinc-400 text-sm">Взлом аккаунтов</span>
                <div className="flex gap-0.5">
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Чек-лист цифровой безопасности</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Проверьте свой уровень защиты по ключевым параметрам безопасности.
            </p>

            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              <h4 className="text-lg font-medium text-zinc-200 mb-5">Ваш профиль защиты</h4>
              ...
              <div className="flex items-center gap-4 mb-4">
                <span className="text-zinc-500 text-sm w-20">Категории</span>
                <div className="flex items-center gap-2">
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-300 text-xs">
                    <span className="text-purple-400">Пароли</span>
                  </span>
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-400 text-xs">
                    <span className="text-yellow-500">2FA</span>
                  </span>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <span className="text-zinc-500 text-sm w-20 pt-1">Прогресс</span>
                <div className="flex flex-col gap-2">
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-green-500" />
                    Надёжный пароль <span className="text-zinc-500">100%</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-green-500" />
                    Двухфакторная аутентификация <span className="text-zinc-500">включена</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-400 text-sm">
                    ...
                    Антивирус <span className="text-zinc-500">25% из 53</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-b border-zinc-800 pt-10 pl-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Уровень угрозы сейчас</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Актуальная информация об активных мошеннических схемах в сети.
            </p>
                ...
                <div className="flex items-center gap-2 mb-2">
                  <span className="w-5 h-5 rounded-full bg-red-500/20 flex items-center justify-center">
                    <svg className="w-3 h-3 text-red-500" viewBox="0 0 16 16" fill="currentColor">
                      <path d="M8 1a7 7 0 100 14A7 7 0 008 1zM7 9V5h2v4H7zm0 2h2v2H7v-2z" />
                    </svg>
                  </span>
                  <span className="text-red-400 font-medium text-sm">Высокий риск</span>
                </div>
                <p className="text-zinc-300 text-sm mb-3">Активная волна фишинга под банки — март 2025</p>
          ...
          <div className="border-r border-zinc-800 pt-16 pr-10 pb-16 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-200 font-medium">Уникальные пароли для каждого сайта</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-green-500/50" />
                <span className="text-zinc-400">Двухфакторная аутентификация везде</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-green-500/30" />
                <span className="text-zinc-500">Проверка ссылок перед переходом</span>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
              ...
              <div className="p-5">
                ...
                <div className="mb-3 relative inline-block">
                  <span className="text-zinc-200 text-lg font-medium">Как распознать</span>
                  <span className="relative mx-1">
                    <span className="text-zinc-200 text-lg font-medium bg-red-500/20 px-0.5">мошенника</span>
                ...
                <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                  ...
                  <span className="relative inline">
                    <span className="bg-purple-500/20 px-0.5">фишинга</span>
                    <span className="absolute -bottom-4 left-0 px-1.5 py-0.5 rounded text-[10px] bg-purple-600 text-white">
                      пример
                    </span>
                  </span>
                  {" "}и скама: срочность, незнакомые отправители, подозрительные ссылки и просьбы передать данные карты.
                </p>
