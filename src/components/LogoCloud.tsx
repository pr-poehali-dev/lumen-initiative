...
import { Sparkles, Zap, Globe, Hexagon, Diamond, Star, Circle, ShieldCheck } from "lucide-react"

const companies = [
  { name: "Роскомнадзор", icon: ShieldCheck },
  { name: "МВД России", icon: Zap },
  { name: "Сбербанк", icon: Hexagon },
  { name: "Group-IB", icon: Diamond },
  { name: "Kaspersky", icon: Star },
  { name: "ЦБ России", icon: Sparkles },
  { name: "Positive Tech", icon: Globe },
  { name: "НКЦКИ", icon: Circle },
]
    ...
    <div className="relative z-20 pb-24 pt-8" style={{ backgroundColor: "#09090B" }}>
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-4xl text-center">
          ...
          >
            Данные проверены экспертами в области кибербезопасности.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Материалы основаны на официальной статистике и реальных случаях мошенничества.
          </motion.p>
